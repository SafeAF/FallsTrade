...
class ServiceProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_provider" do
    assert_difference("ServiceProvider.count") do
      post service_providers_url, params: { service_provider: { bio: @service_provider.bio, company: @service_provider.company, email: @service_provider.email, name: @service_provider.name, phone: @service_provider.phone, user_id: @service_provider.user_id } }
    end
  ...
  test "should update service_provider" do
    patch service_provider_url(@service_provider), params: { service_provider: { bio: @service_provider.bio, company: @service_provider.company, email: @service_provider.email, name: @service_provider.name, phone: @service_provider.phone, user_id: @service_provider.user_id } }
